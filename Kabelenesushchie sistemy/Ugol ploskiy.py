...
url = 'https://001.com.ua/magistralnye-kabel-kanaly-koroba?filters=407'
...
def get_cat_html_ru():
    ...
    try:
        ...
        with open('ugol-plosjiy.csv', 'w', newline='', encoding='utf-8-sig') as f:
