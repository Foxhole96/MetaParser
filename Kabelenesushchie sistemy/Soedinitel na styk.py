...
url = 'https://001.com.ua/magistralnye-kabel-kanaly-koroba?filters=413'
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Соединитель на стык',
        ...
        with open('soedinitel-na-styk.csv', 'w', newline='', encoding='utf-8-sig') as f:
