...
url = 'https://001.com.ua/sharnirno-gubtsevyy-instrument'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            device_type = test_pars_capitalize(soup=soup, name='Тип инструмента')
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Шарнирно-губцевый инструмент',
        ...
        with open('sharnirno-gubtsevyy-instrument.csv', 'w', newline='', encoding='utf-8-sig') as f:
