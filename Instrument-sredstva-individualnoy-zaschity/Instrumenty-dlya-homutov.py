...
url = 'https://001.com.ua/instrumenty-dlya-homutov'
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Инструменты для хомутов',
        ...
        with open('instrumenty-dlya-homutov.csv', 'w', newline='', encoding='utf-8-sig') as f:
