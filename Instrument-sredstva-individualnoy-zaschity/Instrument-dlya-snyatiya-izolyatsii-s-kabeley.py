...
url = 'https://001.com.ua/instrument-dlya-snyatiya-izolyatsii-s-kabeley'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            min_diametr = test_pars_capitalize(soup=soup, name='Минимальный диаметр кабеля, мм')
            max_diametr = test_pars_capitalize(soup=soup, name='Максимальный диаметр кабеля, мм')
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Инструмент для снятия изоляции с кабелей',
                ...
                'Минимальный диаметр кабеля': f'Русский ~ {min_diametr}',
                'Максимальный диаметр кабеля': f'Русский ~ {max_diametr}',
        ...
        with open('instrument-dlya-snyatiya-izolyatsii-s-kabeley.csv', 'w', newline='', encoding='utf-8-sig') as f:
