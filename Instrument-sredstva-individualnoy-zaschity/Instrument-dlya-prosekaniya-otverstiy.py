...
url = 'https://001.com.ua/instrument-dlya-prosekaniya-otverstiy'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            diametr = test_pars_capitalize(soup=soup, name='Диаметр просекаемых отверстий, мм')
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Инструмент для просекания отверстий',
                ...
                'Диаметр просекаемых отверстий': f'Русский ~ {diametr}',
        ...
        with open('instrument-dlya-prosekaniya-otverstiy.csv', 'w', newline='', encoding='utf-8-sig') as f:
