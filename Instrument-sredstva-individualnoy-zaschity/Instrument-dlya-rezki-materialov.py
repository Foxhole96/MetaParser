...
url = 'https://001.com.ua/instrument-dlya-rezki-materialov'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            max_diametr = test_pars_capitalize(soup=soup, name='Максимальный диаметр резки, мм')
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Инструмент для резки материалов',
                ...
                'Максимальный диаметр резки': f'Русский ~ {max_diametr}',
        ...
        with open('instrument-dlya-rezki-materialov.csv', 'w', newline='', encoding='utf-8-sig') as f:
