...
url = 'https://001.com.ua/magnitnye-derzhateli-pozitsionery'
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Магнитные держатели (позиционеры)',
        ...
        with open('magnitnye-derzhateli-pozitsionery.csv', 'w', newline='', encoding='utf-8-sig') as f:
