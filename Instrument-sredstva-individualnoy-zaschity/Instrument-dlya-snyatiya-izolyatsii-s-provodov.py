...
url = 'https://001.com.ua/instrument-dlya-snyatiya-izolyatsii-s-provodov'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            min_diametr = test_pars_capitalize(soup=soup, name='Минимальное сечение провода, мм²')
            max_diametr = test_pars_capitalize(soup=soup, name='Максимальное сечение провода, мм²')
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Инструмент для снятия изоляции с проводов',
                ...
                'Минимальное сечение провода': f'Русский ~ {min_diametr}',
                'Максимальное сечение провода': f'Русский ~ {max_diametr}',
        ...
        with open('instrument-dlya-snyatiya-izolyatsii-s-provodov.csv', 'w', newline='', encoding='utf-8-sig') as f:
