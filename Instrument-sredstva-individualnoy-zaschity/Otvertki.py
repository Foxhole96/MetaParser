...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            spline_type = test_pars_capitalize(soup=soup, name='Тип шлица')
            spline_size = test_pars_capitalize(soup=soup, name='Размер шлица, мм')
            ...
            data.append({
                ...
                'Тип шлица': f'Русский ~ {spline_type}',
                'Размер шлица': f'Русский ~ {spline_size}',
        ...
        with open('otvertki.csv', 'w', newline='', encoding='utf-8-sig') as f:
