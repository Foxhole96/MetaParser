...
url = 'https://001.com.ua/instrument-dlya-rezki-kabelya'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            min_diametr = test_pars_capitalize(soup=soup, name='Максимальное сечение кабеля/провода, мм²')
            ...
            data.append({
                ...
                'Максимальное сечение провода': f'Русский ~ {min_diametr}',
        ...
        with open('instrument-dlya-rezki-kabelya.csv', 'w', newline='', encoding='utf-8-sig') as f:
