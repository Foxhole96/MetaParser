...
url = 'https://001.com.ua/rele-kontrolya-napryazheniya-i-faz'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in all_product_links:
            ...
            mclc = test_pars(soup=soup, name='Максимальный длительный ток нагрузки, А')
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Реле контроля напряжения и фаз',
                ...
                'Максимальный длительный ток нагрузки': f'Русский ~ {mclc}',
        ...
        with open('rele-kontrolya-napryazheniya-i-faz.csv', 'w', encoding='utf-8-sig') as f:
            writer = csv.DictWriter(f, fieldnames=['URL',
                                                   ...
                                                   'Количество фаз',
                                                   'Максимальный длительный ток нагрузки',
                                                   'Способ монтажа',
                                                   ])
            writer.writeheader()
            for data in data:
