...
url = 'https://001.com.ua/rele-kontrolya-toka'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in all_product_links:
            ...
            mcs = test_pars(soup=soup, name='Максимальная уставка по току, А')
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Реле контроля тока',
                ...
                'Максимальная уставка по току': f'Русский ~ {mcs}',
        ...
        with open('rele-kontrolya-toka.csv', 'w', encoding='utf-8-sig') as f:
