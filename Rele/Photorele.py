...
url = 'https://001.com.ua/fotorele-sumerechnye-rele'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in all_product_links:
            ...
            maximum_current = test_pars(soup=soup, name='Максимальный ток нагрузки, А')
            ...
            data.append({
                ...
                'Максимальный ток': f'Русский ~ {maximum_current}',
        ...
        with open('fotorele-sumerechnye-rele.csv', 'w', encoding='utf-8-sig') as f:
