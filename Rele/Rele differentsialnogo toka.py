...
url = 'https://001.com.ua/rele-differentsialnogo-toka'
    ...
    try:
        ...
        for product_url in all_product_links:
            ...
            data.append({
                ...
                'Тип устройства': f'Русский ~ Реле дифференциального тока',
            })
            driver.find_element(By.XPATH, '/html/body/header/nav/div/div[2]/ul[2]/li[1]/a/span[1]').click()
            time.sleep(2)

        with open('rele-differentsialnogo-toka.csv', 'w', encoding='utf-8-sig') as f:
