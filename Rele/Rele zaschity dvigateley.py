...
url = 'https://001.com.ua/rele-zaschity-dvigateley'
    ...
    try:
        ...
        for product_url in all_product_links:
            ...
            data.append({
                ...
                'Тип устройства': f'Русский ~ Реле защиты двигателей',
        ...
        with open('rele-zaschity-dvigateley.csv', 'w', encoding='utf-8-sig') as f:
