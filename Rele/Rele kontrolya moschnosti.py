...
url = 'https://001.com.ua/rele-kontrolya-moschnosti'
    ...
    try:
        ...
        for product_url in all_product_links:
            ...
            data.append({
                ...
                'Тип устройства': f'Русский ~ Реле контроля мощности',
        ...
        with open('rele-kontrolya-moschnosti.csv', 'w', encoding='utf-8-sig') as f:
