...
url = 'https://001.com.ua/rele-impulsnye'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in all_product_links:
            ...
            num_of_contats = test_pars(soup=soup, name='Количество контактов')
            ...
            data.append({
                ...
                'Тип устройства': f'Русский ~ Импульсное реле',
                'Количество контактов': f'Русский ~ {num_of_contats}',
        ...
        with open('rele-impulsnye.csv', 'w', encoding='utf-8-sig') as f:
