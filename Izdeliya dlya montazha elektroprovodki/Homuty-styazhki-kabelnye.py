...
url = 'https://001.com.ua/homuty-styazhki-kabelnye'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            if width == '0':
                width = ''
            lenth = test_pars(soup=soup, name='Длина, мм')
            if lenth == '0':
                lenth = ''
        ...
        with open('homuty-styazhki-kabelnye.csv', 'w', newline='', encoding='utf-8-sig') as f:
