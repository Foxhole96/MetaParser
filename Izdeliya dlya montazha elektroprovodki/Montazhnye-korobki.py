...
url = 'https://001.com.ua/montazhnye-korobki'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            protection = test_pars(soup=soup, name='Степень защиты')
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Монтажные коробки',
                ...
                'Степень защиты': f'Русский ~ {protection}',
            })
            driver.find_element(By.XPATH, '/html/body/header/nav/div/div[2]/ul[2]/li[1]/a/span[1]').click()
            time.sleep(2)

        with open('montazhnye-korobki.csv', 'w', newline='', encoding='utf-8-sig') as f:
