...
url = 'https://001.com.ua/marker-kabelnyy'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            max_cable_section = test_pars(soup=soup, name='Максимальное сечение проводников, мм²')
            marking = test_pars_capitalize(soup=soup, name='Маркировка')
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Маркер кабельный',
                ...
                'Максимальное сечение проводников': f'Русский ~ {max_cable_section}',
                'Маркировка': f'Русский ~ {marking}',
            })
            driver.find_element(By.XPATH, '/html/body/header/nav/div/div[2]/ul[2]/li[1]/a/span[1]').click()
            time.sleep(2)

        with open('marker-kabelnyy.csv', 'w', newline='', encoding='utf-8-sig') as f:
