...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            thickness = test_pars(soup=soup, name='Толщина, мм')
            width = test_pars(soup=soup, name='Ширина, мм')
            lenth = test_pars(soup=soup, name='Длина, м')
            ...
            data.append({
                ...
                'Толщина': f'Русский ~ {thickness}',
                'Ширина': f'Русский ~ {width}',
                'Длина': f'Русский ~ {lenth}',
        ...
        with open('izolenta.csv', 'w', newline='', encoding='utf-8-sig') as f:
