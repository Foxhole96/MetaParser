...
url = 'https://001.com.ua/nakonechniki-gilzy-razemy'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            color = test_pars_capitalize(soup=soup, name='Цвет изоляции')
            if color == 'Слоновая кость':
                color = 'Белый'
            elif color == 'Без изоляции':
                color = ''
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Наконечники, гильзы, разъемы',
        ...
        with open('nakonechniki-gilzy-razemy.csv', 'w', newline='', encoding='utf-8-sig') as f:
