...
url = 'https://001.com.ua/klemmniki-i-klemmnye-kolodki'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            num_of_terminals = test_pars(soup=soup, name='Количество клемм')
            cable_section = test_pars(soup=soup, name='Сечение соединяемых проводов, мм²')
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Клеммники и клеммные колодки',
                ...
                'Количество клемм': f'Русский ~ {num_of_terminals}',
        ...
        with open('klemmniki-i-klemmnye-kolodki.csv', 'w', newline='', encoding='utf-8-sig') as f:
