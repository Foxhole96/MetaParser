...
url = 'https://001.com.ua/bandazhnaya-lenta-skrepy'
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Скрепы, бандажная лента, натяжители',
        ...
        with open('bandazhnaya-lenta-skrepy.csv', 'w', newline='', encoding='utf-8-sig') as f:
