...
url = 'https://001.com.ua/gilzy-soedinitelnye-i-nakonechniki-izolirovannye'
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Гильзы соединительные и наконечники изолированные',
        ...
        with open('gilzy-soedinitelnye-i-nakonechniki-izolirovannye.csv', 'w', newline='', encoding='utf-8-sig') as f:
