...
url = 'https://001.com.ua/dopolnitelnye-ustroystva-modulnoy-serii'
...
def get_cat_html_ru():
    ...
    try:
        ...
        with open('dopolnitelnye-ustroystva-modulnoy-serii.csv', 'w', encoding='utf-8-sig') as f:
