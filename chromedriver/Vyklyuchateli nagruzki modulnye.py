...
url = 'https://001.com.ua/vyklyuchateli-nagruzki-modulnye'
    ...
    try:
        ...
        for product_url in all_product_links:
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Выключатели нагрузки модульные',
        ...
        with open('vyklyuchateli-nagruzki-modulnye.csv', 'w', encoding='utf-8-sig') as f:
