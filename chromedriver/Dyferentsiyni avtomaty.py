...
url = 'https://001.com.ua/differentsialnye-avtomaty-avdt'
    ...
    try:
        ...
        for product_url in all_product_links:
            ...
            try:
                ...
                if type_select:
                    type_el = type_select['title']
                else:
                    type_el = type_td.text.strip()
            except AttributeError:
                type_el = 'ERROR'
            ...
            data.append({
                ...
                'Тип': f'Русский ~ {type_el} ;; Украинский ~ {type_el}',
                'Характеристика отключения': f'Русский ~ {shutdown_characteristic} ;;'
                                             f' Украинский ~ {shutdown_characteristic}',
        ...
        with open('differentsialnye-avtomaty-avdt.csv', 'w', encoding='utf-8-sig') as f:
