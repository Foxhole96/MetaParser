...
url = 'https://001.com.ua/kabeli-silovye-mednye'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            cable_type = test_pars_capitalize(soup=soup, name='Марка кабеля')
            cable_section = test_pars_capitalize(soup=soup, name='Сечение, мм²').split('×')[1]
            num_of_cores = test_pars_capitalize(soup=soup, name='Сечение, мм²')[0]
            ...
            data.append({
                ...
                'Тип проводника': f'Русский ~ Многожильный',

            })
            driver.find_element(By.XPATH, '/html/body/header/nav/div/div[2]/ul[2]/li[1]/a/span[1]').click()
            time.sleep(2)

        with open('kabeli-silovye-mednye.csv', 'w', newline='', encoding='utf-8-sig') as f:
