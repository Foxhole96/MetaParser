...
url = 'https://001.com.ua/stabilizatory-napryazheniya'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            power = test_pars(soup=soup, name='Мощность, кВА')
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Стабилизаторы напряжения',
        ...
        with open('stabilizatory-napryazheniya.csv', 'w', newline='', encoding='utf-8-sig') as f:
