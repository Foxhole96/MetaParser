...
url = 'https://001.com.ua/schity-s-montazhnoy-panelyu-plastikovye'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            height = test_pars(soup=soup, name='Высота, мм')
            width = test_pars(soup=soup, name='Ширина, мм')
            depth = test_pars(soup=soup, name='Глубина, мм')
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Щиты с монтажной панелью',
        ...
        with open('schity-s-montazhnoy-panelyu-plastikovye.csv', 'w', newline='', encoding='utf-8-sig') as f:
