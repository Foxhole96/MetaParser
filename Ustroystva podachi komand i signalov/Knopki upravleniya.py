...
url = 'https://001.com.ua/knopki-upravleniya'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            button_type = test_pars_capitalize(soup=soup, name='Тип кнопки')
            contactor_type = test_pars_capitalize(soup=soup, name='Тип контакта')
            color = test_pars_capitalize(soup=soup, name='Цвет')
            marking = test_pars(soup=soup, name='Маркировка')
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Кнопки управления',
                ...
                'Тип кнопки': f'Русский ~ {button_type}',
                'Количество и вид контактов': f'Русский ~ {contactor_type}',
                'Цвет': f'Русский ~ {color}',
                'Маркировка': f'Русский ~ {marking}',
        ...
        with open('knopki-upravleniya.csv', 'w', newline='', encoding='utf-8-sig') as f:
