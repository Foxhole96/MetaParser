...
url = 'https://001.com.ua/zvonki-elektricheskie'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            sound_pressure = test_pars_capitalize(soup=soup, name='Звуковое давление')
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Звонки электрические',
                ...
                'Звуковое давление': f'Русский ~ {sound_pressure}',
        ...
        with open('zvonki-elektricheskie.csv', 'w', newline='', encoding='utf-8-sig') as f:
