...
url = 'https://001.com.ua/pulty-knopochnye-telfernye'
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Пульты кнопочные тельферные',
                ...
                'Количество основных кнопок': f'Русский ~ {num_of_buttons}',
                'Функции': f'Русский ~ {functions}',
                'Наличие кнопки СТОП': f'Русский ~ {stop_button}',
        ...
        with open('pulty-knopochnye-telfernye.csv', 'w', newline='', encoding='utf-8-sig') as f:
