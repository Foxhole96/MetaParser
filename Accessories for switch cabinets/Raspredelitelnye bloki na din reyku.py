...
url = 'https://001.com.ua/raspredelitelnye-bloki-na-din-reyku'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            lead_in_clamps = test_pars(soup=soup, name='Вводные зажимы, мм²')
            terminal_clamps = test_pars(soup=soup, name='Выводные зажимы, мм²')
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Распределительные блоки на DIN-рейку',
                ...
                'Вводные зажимы': f'Русский ~ {lead_in_clamps}',
                'Выводные зажимы': f'Русский ~ {terminal_clamps}',

            })
            driver.find_element(By.XPATH, '/html/body/header/nav/div/div[2]/ul[2]/li[1]/a/span[1]').click()
            time.sleep(2)

        with open('raspredelitelnye-bloki-na-din-reyku.csv', 'w', newline='', encoding='utf-8-sig') as f:
