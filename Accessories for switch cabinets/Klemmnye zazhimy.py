...
url = 'https://001.com.ua/klemmnye-zazhimy'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            max_cross_section = test_pars(soup=soup, name='Максимальное сечение соединяемых проводов, мм²')
            nominal_current = test_pars(soup=soup, name='Номинальный ток, А')
            color = test_pars_capitalize(soup=soup, name='Цвет')
            color = color.replace('Желто-зеленый', 'Зеленый')
            ...
            data.append({
                ...
                'Максимальное сечение соединяемых проводов': f'Русский ~ {max_cross_section}',
        ...
        with open('klemmnye-zazhimy.csv', 'w', newline='', encoding='utf-8-sig') as f:
            writer = csv.DictWriter(f, fieldnames=['URL',
                                                   ...
                                                   'Тип оборудования',
                                                   'Максимальное сечение соединяемых проводов',
                                                   'Номинальный ток',
                                                   'Цвет товара',
