...
url = 'https://001.com.ua/shiny-nulevye-v-korpuse'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            device_type = 'Шина нулевая в корпусе'
            num_of_tires = test_pars(soup=soup, name='Количество нулевых шин')
            num_of_holes = test_pars(soup=soup, name='Суммарное количество отверстий подключения')
            ...
            data.append({
                ...
                'Количество нулевых шин': f'Русский ~ {num_of_tires}',
                'Количество отверстий': f'Русский ~ {num_of_holes}',

            })
            driver.find_element(By.XPATH, '/html/body/header/nav/div/div[2]/ul[2]/li[1]/a/span[1]').click()
            time.sleep(2)

        with open('shiny-nulevye-v-korpuse.csv', 'w', newline='', encoding='utf-8-sig') as f:
