...
url = 'https://001.com.ua/predohraniteli-plavkie'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in all_product_links:
            ...
            gabarite = test_pars(soup=soup, name='Габарит')
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Предохранители плавкие',
        ...
        with open('predohraniteli-plavkie.csv', 'w', encoding='utf-8-sig') as f:
