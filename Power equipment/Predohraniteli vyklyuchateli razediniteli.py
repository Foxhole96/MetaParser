...
url = 'https://001.com.ua/predohraniteli-vyklyuchateli-razediniteli'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in all_product_links:
            ...
            rated_thermal_current = test_pars(soup=soup, name='Номинальный тепловой ток, А')
            fuse_size = test_pars(soup=soup, name='Габарит предохранителей')
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Предохранители, выключатели, разъединители',
                ...
                'Номинальный тепловой ток': f'Русский ~ {rated_thermal_current}',
                'Габарит предохранителей': f'Русский ~ {fuse_size}',
        ...
        with open('predohraniteli-vyklyuchateli-razediniteli.csv', 'w', encoding='utf-8-sig') as f:
