...
url = 'https://001.com.ua/silovye-razemy'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in all_product_links:
            ...
            num_of_poles = test_pars(soup=soup, name='Количество полюсов')
            ...
            data.append({
                ...
                'Количество полюсов': f'Русский ~ {num_of_poles}',
        ...
        with open('silovye-razemy.csv', 'w', encoding='utf-8-sig') as f:
