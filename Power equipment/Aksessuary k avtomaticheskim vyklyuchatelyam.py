...
url = 'https://001.com.ua/aksessuary-k-avtomaticheskim-vyklyuchatelyam'
    ...
    try:
        ...
        for product_url in all_product_links:
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Аксессуары к автоматическим выключателям',
        ...
        with open('aksessuary-k-avtomaticheskim-vyklyuchatelyam.csv', 'w', encoding='utf-8-sig') as f:
