...
url = 'https://001.com.ua/avtomaticheskie-vyklyuchateli'
...
def get_cat_html_ru():
    ...
    try:
        ...
        for product_url in all_product_links:
            ...
            maximum_breaking_capacity = test_pars(soup=soup, name='Максимальная отключающая способность, кА')
            release_type = test_pars(soup=soup, name='Тип расцепителя')
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Автоматические выключатели',
                ...
                'Максимальная отключающая способность': f'Русский ~ {maximum_breaking_capacity}',
                'Тип расцепителя': f'Русский ~ {release_type}',
        ...
        with open('avtomaticheskie-vyklyuchateli.csv', 'w', encoding='utf-8-sig') as f:
