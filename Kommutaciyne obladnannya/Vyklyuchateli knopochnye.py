...
url = 'https://001.com.ua/vyklyuchateli-knopochnye'
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Выключатели кнопочные',
        ...
        with open('vyklyuchateli-knopochnye.csv', 'w', newline='', encoding='utf-8-sig') as f:
