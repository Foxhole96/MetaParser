...
url = 'https://001.com.ua/rele-elektroteplovye'
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Реле электротепловые',
                ...
                'Диапазон регулирования': f'Русский ~ {control_range}',
                'Номинальный ток контактора': f'Русский ~ {contactor_rated_current}',
                'Серия контактора': f'Русский ~ {contactor_series}',
        ...
        with open('rele-elektroteplovye.csv', 'w', newline='', encoding='utf-8-sig') as f:
