...
url = 'https://001.com.ua/oborudovanie-dlya-askue'
    ...
    try:
        ...
        for product_url in tqdm(all_product_links, desc="Парсинг", unit="посилання"):
            ...
            data.append({
                ...
                'images': images_str,
                'item_name': title,
                'category_name': 'Оборудование для АСКУЭ',
        ...
        with open('oborudovanie-dlya-askue.csv', 'w', newline='', encoding='utf-8-sig') as f:
